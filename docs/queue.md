...
## Now
- [ ] Revalidate the helper against a representative remote-backed repo only if end-to-end push confirmation is still needed.

## Next
- [ ] Verify `scripts/check-prompt-drift.sh` still passes after the helper change.
